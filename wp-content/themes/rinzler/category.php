...
<section class="hero <?php if (category_description( $category_id )) { ?>image-large <?php } else { ?> image-medium <?php } ?>overlay" style="background-image: url('<?php echo $category_image['url']; ?>')">
	<div class="wrapper">
