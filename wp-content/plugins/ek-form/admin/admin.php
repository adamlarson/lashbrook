...
function wpcf7_admin_menu() {
	add_object_page( __( 'EK Forms', 'contact-form-7' ),
		__( 'EK Forms', 'contact-form-7' ),
		'wpcf7_read_contact_forms', 'wpcf7',
		'wpcf7_admin_management_page', 'dashicons-clipboard', 29.999 );

	$edit = add_submenu_page( 'wpcf7',
		__( 'Edit Form', 'contact-form-7' ),
		__( 'Forms', 'contact-form-7' ),
		'wpcf7_read_contact_forms', 'wpcf7',
	...
	$addnew = add_submenu_page( 'wpcf7',
		__( 'Add New Form', 'contact-form-7' ),
...
<h2><?php
	echo esc_html( __( 'EK Forms', 'contact-form-7' ) );
...
<h2><?php echo esc_html( __( 'Add New Form', 'contact-form-7' ) ); ?></h2>
...
function wpcf7_admin_updated_message() {
	...
	if ( 'created' == $_REQUEST['message'] ) {
		$updated_message = __( 'Form created.', 'contact-form-7' );
	} elseif ( 'saved' == $_REQUEST['message'] ) {
		$updated_message = __( 'Form saved.', 'contact-form-7' );
	} elseif ( 'deleted' == $_REQUEST['message'] ) {
		$updated_message = __( 'Form deleted.', 'contact-form-7' );
	}
...
<p><?php echo sprintf( __( '<strong>EK Forms (CF7) %1$s requires WordPress %2$s or higher.</strong> Please <a href="%3$s">update WordPress</a> first.', 'contact-form-7' ), WPCF7_VERSION, WPCF7_REQUIRED_WP_VERSION, admin_url( 'update-core.php' ) ); ?></p>
</div>
<?php
}
...
function wpcf7_not_allowed_to_edit() {
	...
	$message = __( "You are not allowed to edit this form.",
		'contact-form-7' );
