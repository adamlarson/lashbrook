<?php
/*
   Plugin Name: EK Form Bin (CFDB Fork)
   Plugin URI: http://wordpress.org/extend/plugins/contact-form-7-to-database-extension/
   Version: 2.9.10
   Author: Eli Kirk / Michael Simpson
   Description: Save form submissions from EK Forms (CF7 Fork) Plugin
   Text Domain: ek-form-to-db
   License: GPL3
  */
