...
class CF7DBOptionsManager {
    ...
    public function settingsPage() {
        ...
        <div class="wrap">
            ...
            <h2>EK Forms <?php echo htmlspecialchars(__('Settings', 'contact-form-7-to-database-extension')); ?></h2>
            <style>
                td {
                    padding: 0 15px;
                }
            ...
            <div style="text-align: right;">
                Based on <img src="<?php echo $this->getPluginFileUrl('img/icon-50x50.png') ?>" alt=""/>
            </div>
        </div>
        <?php
    }
